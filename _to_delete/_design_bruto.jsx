...
//  InfoRow — fora do componente, senão o React recria o input a cada tecla
//  e o cursor salta para o fim do texto.
// O endereco publico da barbearia. Nao usa o InfoRow generico porque precisa
// de normalizar o que se escreve, recusar nomes reservados, confirmar que
// mais ninguem o usa, e avisar que o endereco antigo deixa de funcionar.
